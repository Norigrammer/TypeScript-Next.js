...
const culture = [
  ...
  },
  {
    icon: Briefcase,
    title: '多様なキャリア',
    description: '3つの事業で多様なキャリアパスを描くことができます。',
  },
]
  ...
  return (
    <>
      <Hero
        ...
        backgroundImage="/images/recruit/recruit_main.jpg"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mb-4 text-sm leading-relaxed text-muted-foreground sm:mb-6 sm:text-base">
              一美Groupは2026年に設立したばかりのスタートアップです。営業代行・AI・スーツ販売の3つの事業を展開し、お客様の多様なニーズにお応えしています。
            </p>
